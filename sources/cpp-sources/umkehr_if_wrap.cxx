...
#define SWIGTYPE_p_std__listT_std__string_std__allocatorT_std__string_t_t swig_types[7]
...
/*-----------------------------------------------
              @(target):= _umkehr_if.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__umkehr_if

#else
#  define SWIG_init    init_umkehr_if

#endif
#define SWIG_name    "_umkehr_if"
...
SWIGINTERN PyObject *_wrap_set_umkehr_inputfolder(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:set_umkehr_inputfolder",&obj0)) SWIG_fail;
  res1 = SWIG_AsCharPtrAndSize(obj0, &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "set_umkehr_inputfolder" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = reinterpret_cast< char * >(buf1);
  result = (bool)set_umkehr_inputfolder((char const *)arg1);
  resultobj = SWIG_From_bool(static_cast< bool >(result));
...
SWIGINTERN PyObject *_wrap_get_output_stream(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:get_output_stream",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "get_output_stream" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  result = (std::list< std::string,std::allocator< std::string > > *) &get_output_stream(arg1);
  resultobj = swig::from(static_cast< std::list< std::string,std::allocator< std::string > > >(*result));
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_get_input_stream(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"O:get_input_stream",&obj0)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "get_input_stream" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  result = (std::list< std::string,std::allocator< std::string > > *) &get_input_stream(arg1);
  resultobj = swig::from(static_cast< std::list< std::string,std::allocator< std::string > > >(*result));
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_set_umkehr_input_filename(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  int arg1 ;
  char *arg2 = (char *) 0 ;
  int val1 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:set_umkehr_input_filename",&obj0,&obj1)) SWIG_fail;
  ecode1 = SWIG_AsVal_int(obj0, &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "set_umkehr_input_filename" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = static_cast< int >(val1);
  res2 = SWIG_AsCharPtrAndSize(obj1, &buf2, NULL, &alloc2);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "set_umkehr_input_filename" "', argument " "2"" of type '" "char const *""'");
  }
  arg2 = reinterpret_cast< char * >(buf2);
  set_umkehr_input_filename(arg1,(char const *)arg2);
  resultobj = SWIG_Py_Void();
  if (alloc2 == SWIG_NEWOBJ) delete[] buf2;
  return resultobj;
fail:
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"set_umkehr_input_filename", _wrap_set_umkehr_input_filename, METH_VARARGS, NULL},
	 { (char *)"analyze_umkehr", _wrap_analyze_umkehr, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static swig_type_info _swigt__p_std__allocatorT_std__string_t = {"_p_std__allocatorT_std__string_t", "std::list< std::string >::allocator_type *|std::allocator< std::string > *", 0, 0, (void*)0, 0};
