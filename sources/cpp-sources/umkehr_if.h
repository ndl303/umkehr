...
#if defined (_MSC_VER)
#define fortran_char_int				int
#else
#define fortran_char_int				size_t
#endif
...
extern "C" void UMKEHR_SET_INPUTFOLDER( const char* str, fortran_char_int len );
extern "C" void UMKEHR_SET_IONAMES    ( int* JUNIT,  const char* str, fortran_char_int len );
